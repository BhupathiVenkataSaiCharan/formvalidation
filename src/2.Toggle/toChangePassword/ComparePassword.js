                    ...
                    <form onSubmit={handleSubmits} >
                        <div className='container'>
                            <div style={{justifyContent:"left"}}>
                                <label style={{position:"relative", top:"1px",right:"5px",left:"135px"}} ><LockIcon/></label>
                                <input className='input_fieldp1' type="password" name='password' placeholder='new password'
                            ...
                            <br/>
                            <div>
                                <label style={{position:"relative", top:"1px",right:"5px",left:"120px"}} ><LockIcon/></label>
                                <input className='input_fieldp2' type="password" name='confirmpassword' placeholder='repeat new password'
